...
class ajax_showPage{
  ...
  function construct_num_Page(){   
	...
	function show_SubPages($subPage_type){
		if($subPage_type==1){
			...
			$this->subPageCss2();
		}else if($subPage_type==3){
			$this->subPageCss3();
		}else if($subPage_type==4){
			$this->subPageCss4();
		}else if($subPage_type==5){
			$this->subPageCss5();
		}
	}
  ...
  function subPageCss2(){   
   ...
   $subPageCss2Str.="<div class='pager'>";   
    ...
    $subPageCss2Str.="<a onclick='fun(1,$typeId)'>首页</a> ";   
    $subPageCss2Str.="<a onclick='fun($prewPageUrl,$typeId)'>上一页</a> ";   
    }else {   
   ...
   $a=$this->construct_num_Page(); 
    ...
    $s=$a[$i];   
     ...
     $subPageCss2Str.="<a onclick='fun($s,$typeId)'>".$s."</a> ";   
     }   
    }   
    ...
    $subPageCss2Str.=" <a onclick='fun($nextPageUrl,$typeId)'>下一页</a> ";   
    $subPageCss2Str.="<a onclick='fun($lastPageUrl,$typeId)'>尾页</a> ";   
    }else {   
  ...
  function subPageCss4(){   
   ...
   $subPageCss2Str.="<div class='pager'>";   
    ...
    if($this->current_page > 1){   
    $prewPageUrl=$this->current_page-1;   
    $subPageCss2Str.="<a onclick='fun1(1,$keywords)'>首页</a> ";   
    $subPageCss2Str.="<a onclick='fun1($prewPageUrl,$keywords)'>上一页</a> ";   
    }else {   
    $subPageCss2Str.="<a>首页</a> ";   
    $subPageCss2Str.="<a>上一页</a> ";   
    }   
   ...
   $a=$this->construct_num_Page();   
    ...
    $s=$a[$i];   
     ...
     $subPageCss2Str.="<a onclick='fun1($s,\"$keywords\")'>".$s."</a> ";   
     }   
    }   
    ...
    $lastPageUrl=$this->pageNums;   
    $nextPageUrl=$this->current_page+1;   
    $subPageCss2Str.=" <a onclick='fun1($nextPageUrl,$keywords)'>下一页</a> ";   
    $subPageCss2Str.="<a onclick='fun1($lastPageUrl,$keywords)'>尾页</a> ";   
    }else {   
    $subPageCss2Str.="<a>下一页</a>";   
    $subPageCss2Str.="<a>尾页</a>";   
    }  
  ...
  function subPageCss5(){   
   ...
   $subPageCss2Str.="<div class='pager'>";   
    ...
    if($this->current_page > 1){   
    $prewPageUrl=$this->current_page-1;   
    $subPageCss2Str.="<a onclick='remarkPage(1,$typeId)'>首页</a> ";   
    $subPageCss2Str.="<a onclick='remarkPage($prewPageUrl,$typeId)'>上一页</a> ";   
    }else {   
    $subPageCss2Str.="<a>首页</a> ";   
    $subPageCss2Str.="<a>上一页</a> ";   
    }   
   ...
   $a=$this->construct_num_Page(); 
    ...
    $s=$a[$i];   
     ...
     $subPageCss2Str.="<a onclick='remarkPage($s,$typeId)'>".$s."</a> ";   
     }   
    }   
    ...
    $lastPageUrl=$this->pageNums;   
    $nextPageUrl=$this->current_page+1;   
    $subPageCss2Str.=" <a onclick='remarkPage($nextPageUrl,$typeId)'>下一页</a> ";   
    $subPageCss2Str.="<a onclick='remarkPage($lastPageUrl,$typeId)'>尾页</a> ";   
    }else {   
    $subPageCss2Str.="<a>下一页</a>";   
    $subPageCss2Str.="<a>尾页</a>";   
    }  
