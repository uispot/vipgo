...
<div class="zd-cont">
  	<div class="sidebar">
    	<ul>
<?php
$nav_rs = $db->DB_select_all("`pro_brand`", $select = "*", $where = 1);
//print_r($nav_rs);
foreach($nav_rs as $v){
	if($v['id'] == $id){
		echo "<li class=\"cur\"><a href=\"./zhuda.php?id=".$v['id']."\">".$v['name']."</a></li>";
	}else{
		echo "<li><a href=\"./zhuda.php?id=".$v['id']."\">".$v['name']."</a></li>";
		}
	}
?>       
    ...
    <div class="main">
        <div class="zd-cont-bg">
            <div class="main-right">
                <img src="../images/zhuda/zd-wnjkys.jpg" width="800" height="280"/>   
                <ul class="goods-list">
<?php
$pro_rs = $db->DB_select_all("`pro_data`", $select = "*", "`brand`={$id}");
